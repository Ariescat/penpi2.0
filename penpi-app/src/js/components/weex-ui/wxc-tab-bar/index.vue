    ...
    <div class="tab-title-list"
      ...
      <div class="title-item"
        ...
        <text class="icon-font"
              ...
              :style="{fontFamily: 'iconfont-penpi',fontSize: tabStyles.iconFontSize+'px', color: currentPage == index ? tabStyles.activeIconFontColor : tabStyles.iconFontColor}">{{v.codePoint}}</text>
        <text
          v-if="!titleUseSlot"
